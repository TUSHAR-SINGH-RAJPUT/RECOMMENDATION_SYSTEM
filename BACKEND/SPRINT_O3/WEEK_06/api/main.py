...
from SPRINT_O3.WEEK_06.api.routes.collaborative import (
    router as collaborative_router
)

from SPRINT_O3.WEEK_06.api.routes.embedding import (
    router as embedding_router
)

from SPRINT_O3.WEEK_06.api.routes.hybrid import (
    router as hybrid_router
)

from SPRINT_O3.WEEK_06.api.routes.conversational import (
